...
SEARCHES=(
  # AI agent setup/consultant roles
  "https://www.linkedin.com/jobs/search?keywords=%22AI+agent%22+OR+%22OpenClaw%22+OR+%22personal+AI+assistant%22+OR+%22agent+architect%22+OR+%22AI+automation%22+%28consultant+OR+setup+OR+deploy+OR+configure+OR+freelance%29&f_TPR=r604800&position=1&pageNum=0"
  # AI/LLM engineer roles (remote OK)
  ...
  # Specifically OpenClaw/Hermes related
...
PROMPT="Filter jobs for Brandon Tyler. He's an AWS engineer who builds AI agent systems (OpenClaw, Hermes, kiro-cli) and wants consulting/freelance/full-time opportunities helping others set up personal AI assistants, agent automation, or AI executive assistant systems.
Score 1-5. 5=directly about AI agent setup/consulting/deployment. 4=AI architect or LLM engineer role that fits his skills. 3=related AI/automation role. 2=tangentially related. 1=irrelevant.
Remote or DFW preferred. Consulting/freelance/contract is great.
