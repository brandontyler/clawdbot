...
// Pinned to ACP SDK 0.21.0 via the `sdk-legacy` alias (upstream ships 1.1.0 for
// src/acp/*). kiro-cli 2.11.1's agent speaks the experimental `session/set_model`
// method (unstable_setSessionModel); it returns JSON-RPC -32601 "Method not found"
// for the 1.1.0 `session/set_config_option`. Verified live against the binary.
// Revisit the pin when a kiro-cli release implements set_config_option.
import {
...
} from "@agentclientprotocol/sdk-legacy";
